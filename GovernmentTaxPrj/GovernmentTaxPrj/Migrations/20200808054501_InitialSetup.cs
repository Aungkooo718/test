    ...
    public partial class InitialSetup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxAccount", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IncomeTypeId = table.Column<long>(nullable: false),
                    TotalIncome = table.Column<decimal>(nullable: false),
                    TaxAmount = table.Column<decimal>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxTransaction", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaxTransaction_IncomeType_IncomeTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Township_Region_RegionId",
                        column: x => x.RegionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TownshipId = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaxPayer", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaxPayer_Township_TownshipId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxPayer_TownshipId",
                table: "TaxPayer",
                column: "TownshipId");

            migrationBuilder.CreateIndex(
                name: "IX_TaxTransaction_IncomeTypeId",
                table: "TaxTransaction",
                column: "IncomeTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Township_RegionId",
                table: "Township",
                column: "RegionId");
        }
